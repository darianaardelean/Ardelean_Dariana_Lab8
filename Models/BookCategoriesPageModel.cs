...
namespace Ardelean_Dariana_Lab8.Models
{
    public class BookCategoriesPageModel : PageModel
    {
        public List<AssignedCategoryData> AssignedCategoryDataList;
        public void PopulateAssignedCategoryData(Ardelean_Dariana_Lab8Context context,
        Book book)
        {
        ...
        public void UpdateBookCategories(Ardelean_Dariana_Lab8Context context,
